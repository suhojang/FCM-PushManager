 ...
 */
package egovframework.rte.faq.service;

import java.util.List;


/**  
 * @Class Name : EgovFaqService.java
 * @Description : EgovFaqService Class
...
public interface EgovFaqService {
	...
	List selectFaqList(FaqDefaultVO faqVO) throws Exception;
	 ...
	 * @exception
	 */
    int selectFaqListTotCnt(FaqDefaultVO faqVO);
