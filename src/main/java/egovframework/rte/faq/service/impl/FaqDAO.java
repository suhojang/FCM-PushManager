...
public class FaqDAO extends EgovAbstractDAO {
    ...
    public String insertFaq(FaqVO vo) throws Exception {
        return (String)insert("FaqDAO.insertFaq_S", vo);
    }
    ...
    public FaqVO selectFaq(FaqVO vo) throws Exception {
        return (FaqVO) selectByPk("FaqDAO.selectFaq_S", vo);
    }
	...
	public List selectFaqList(FaqDefaultVO faqVO) throws Exception {
        return list("FaqDAO.selectFaqList_D", faqVO);
    }
    ...
    public int selectFaqListTotCnt(FaqDefaultVO faqVO) {
        return (Integer)getSqlMapClientTemplate().queryForObject("FaqDAO.selectFaqListTotCnt_S", faqVO);
    }
