...
function fn_init(){
	document.getElementById("IPMGR_USEYN").value	= "${result.IPMGRUSEYN}";
}
...
<input type="hidden" name=IPMGR_NO id="IPMGR_NO" value="${result.IPMGRNO }">
					...
					<table class="list_form">
						<tbody>
							<tr>
								...
								<td>
									<input type="text" id="IPMGR_NM" name="IPMGR_NM" size="120" maxlength="10" onfocus="this.select();" value="${result.IPMGRNM }"/> 
								</td>
							</tr>
							<tr>
								<th scope="row">등록 IP</th>
								<td>
									<input type="text" id="IPMGR_IP1" name="IPMGR_IP1" size="5" maxlength="3" onfocus="this.select();" onkeyup="javascript:fn_focus_move(this,3,'IPMGR_IP2')" value="${result.IPMGRIP1 }"/> . 
									<input type="text" id="IPMGR_IP2" name="IPMGR_IP2" size="5" maxlength="3" onfocus="this.select();" onkeyup="javascript:fn_focus_move(this,3,'IPMGR_IP3')" value="${result.IPMGRIP2 }" /> . 
									<input type="text" id="IPMGR_IP3" name="IPMGR_IP3" size="5" maxlength="3" onfocus="this.select();" onkeyup="javascript:fn_focus_move(this,3,'IPMGR_IP4')" value="${result.IPMGRIP3 }" /> .
									<input type="text" id="IPMGR_IP4" name="IPMGR_IP4" size="5" maxlength="3" onfocus="this.select();" value="${result.IPMGRIP4 }" /> 
								</td>
							</tr>
							<tr>
