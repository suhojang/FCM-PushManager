					...
					<table class="list_form">
						<tbody>
							<tr>
								...
								<td>
									<input type="text" id="SVRMGR_NM" name="SVRMGR_NM" size="120" maxlength="10" onfocus="this.select();" /> 
								</td>
							</tr>
							<tr>
								<th scope="row">등록 IP</th>
								<td>
									<input type="text" id="SVRMGR_IP1" name="SVRMGR_IP1" size="5" maxlength="3" onfocus="this.select();" onkeyup="javascript:fn_focus_move(this,3,'SVRMGR_IP2')" /> . 
									<input type="text" id="SVRMGR_IP2" name="SVRMGR_IP2" size="5" maxlength="3" onfocus="this.select();" onkeyup="javascript:fn_focus_move(this,3,'SVRMGR_IP3')" /> . 
									<input type="text" id="SVRMGR_IP3" name="SVRMGR_IP3" size="5" maxlength="3" onfocus="this.select();" onkeyup="javascript:fn_focus_move(this,3,'SVRMGR_IP4')" /> .
									<input type="text" id="SVRMGR_IP4" name="SVRMGR_IP4" size="5" maxlength="3" onfocus="this.select();" /> 
								</td>
							</tr>
							<tr>
